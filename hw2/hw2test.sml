...
val test1_1 = all_except_option("string", ["first", "string", "hi"]) = SOME ["first", "hi"]
...
val test3_2=get_substitutions3([["Fred","Fredrick"],["Jeff","Jeffrey"],["Geoff","Jeff","Jeffrey"]], "Jeff") = ["Jeffrey", "Geoff", "Jeffrey"] 
...
val test10_1 = score([(Hearts, Ace),(Diamonds , Num 4)],10) = 2
val test10_2 = score([(Hearts, Ace)],10) = 0
